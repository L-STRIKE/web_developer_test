...
<head>
    ...
    <!-- <link rel="stylesheet" href="successMsg.css"> -->
    ...
    <div class="container">
        ...
        <nav class="main-nav">
            <div class="logo">
                ...
                <a href="#" class="pineapple-logo">
                    <img src="images/pineapple..png" alt="Pinapple logo">
                </a>
            </div>
            <ul>
                <li>
                    <a href="#" class="main-nav-link first">About</a>
                </li>
                <li>
                    <a href="#" class="main-nav-link second">How it works</a>
                </li>
                <li>
                    <a href="#" class="main-nav-link third">Contact</a>
                </li>
            </ul>
        </nav>

        <main>
            <h1 class="main-heading">Subscribe to newsletter</h1>
            <p class="main-subheading">Subscribe to our newsletter and get 10% discount on pineapple glasses.</p>

            <form class="subscribtion-form needs-validation" action="subscribedEmails.php" method="POST" novalidate>

                <div class="email-container">
                    <div id="v-line"></div>
                    <input id="email" type="email" name="email" placeholder="Type your email address here…" value="<?php echo htmlspecialchars($email) ?>">
                ...
                <?php if(isset($email_error)) { ?> 
                    <p class="invalid-feedback" id="no-email-error"><?php echo $email_error ?></p>
                <?php } ?>

                <!-- <div class="invalid-feedback" id="no-email-error">Email address is required</div>
                <div class="invalid-feedback" id="invalid-email-error">Please provide a valid e-mail address</div>
                <div class="invalid-feedback" id="colombia-email-error">We are not accepting subscriptions from
                    Colombia emails</div> -->

                <div class="terms-container">
                    <input type="checkbox" name="terms" id="terms" hidden checked>
                    <label class="checkbox-label" for="terms"><span id="checkmark" value="on"></span>I agree to <a href="#">terms
                            of service</a></label>
                </div>

                <?php if(isset($terms_error)) { ?> 
                    <p class="invalid-feedback" id="tos-error"><?php echo $terms_error ?></p>
                <?php } ?>

                <!-- <div class="invalid-feedback" id="tos-error">You must accept the terms and conditions</div> -->
            </form>
        ...
        <aside class="side-img-container">
            <img src="images/image_summer.png" alt="Image of pineapple">
        </aside>
    </div>
